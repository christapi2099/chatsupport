...
export default function MobileScreenHistory() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mx-4 my-28">
      ...
      >
        ...
        <button className="bg-primary-400 text-white font-bold inline-flex mb-8 px-4 py-2 rounded-[0.6rem] gap-2 items-center">
          New conversation <PencilSquareIcon className="w-6" />
        </button>

        <div className="flex flex-col gap-2 cursor-pointer h-[68dvh] overflow-y-auto w-full self-start">
          {" "}
